...
(* OASIS_START *)
(* DO NOT EDIT (digest: dfcf5659910c9276b881ac863d6ef085) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Typeinf"; "Imp"; "Smtlib"];
                      lib_pack = false;
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\135\147\139H&\152eæ\002\000¬.\138\005LA";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
