...
(* OASIS_START *)
(* DO NOT EDIT (digest: 24dbbb3faf720dd896664601ded0724f) *)
(*
...
let setup_t =
  {
       ...
       OCamlbuildPlugin.build
         {
            ...
            extra = ["-use-ocamlfind"; "-cflags"; "-w,-40,-short-paths"]
         };
     test =
       [
          ("all_tests",
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "CS631 Support Code Documentation";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_digest = Some "\132\017\0202fi\163Vf\011\159\202\134\159\240\170";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
